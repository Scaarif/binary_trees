 ...
 * @node: pointer to the node (a binary_tree_t node)
 * @next: pointer to the node's next (node)
 */
 ...
 * @front: pointer to the queue's front node
 * @rear: pointer to the queue's rear node
 */
